...
<div id="event" class="event my-5">
  <section class="container-fluid px-3 px-md-5">
    <h5 class="text-uppercase purple mb-4 fs-3">
      Discover the latest and greatest happening near you
    </h5>

    <h6 class="text-uppercase purple mb-5 fs-5">Recurring and upcoming events</h6>
  ...
  <section class="container-fluid events p-5 my-5">
    ...
    <div class="row my-2" style="clear: both">
      ...
      <div class="col px-5">
        ...
        @if (Auth::check())
        <a href="{{ route('poster.create') }}" class="text-decoration-none purple fs-6">Click here to create an event</a>
        @else
