...
<section class="container-fluid px-3 px-md-5">
    <div class="d-flex justify-content-between align-items-center">
        <div>
            <h4 class="purple text-uppercase my-5">Manage admins</h4>
        </div>
        <div>
    ...
    <div class="modal fade" tabindex="-1" id="addAdmin" tabindex="-1" aria-labelledby="addAdmin" aria-hidden="true">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.createAdmin.create') }}" method="post">
                    @csrf
                    @method('post')
        ...
        <div class="col-md-8 mx-auto">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Admins <sup><span class="badge bg-success">{{count($users)}}</span></sup></h3>
                                    ...
                                    <div class="modal fade" id="cat{{ $key }}">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Are you sure you want to remove this admin - {{$user->first_name}} {{$user->last_name}}?
                                                </div>
                                                <div class="modal-footer">
                                                    <form action="{{ route('admin.createAdmin.remove', $user->id) }}" method="post">
                                                        @csrf
                                                        @method('delete')
